...
param_star = [m;c;k];
param_guess = [2 1 6]; % We will fix f0 and omegaF
...
noisy_data = true_data+normrnd(0,0.1,1,length(tspace));
...
q_all = [q(:); 0; 0]; % Homogeneous problem
[~,y] = ode45(@spring_model_3par,tspace,IC,[],q_all);
y = y(:,1)';
end

function dy = spring_model_3par(t,y,params)
